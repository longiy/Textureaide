...
": "3D Viewport > Sidebar > Tool Tab",
    "description": "Match object dimensions to texture dimensions with UDIM support",
    "category": "Mesh",
    "doc_url": "",
    "tracker_url": "",
    "support": "COMMUNITY",
...
def register():
    ...
    print("=" * 50)
    print("Registering Enhanced TextureAide (UDIM)")
    print("=" * 50)
...
def unregister():
    ...
    print("=" * 50)
    print("Unregistering Enhanced TextureAide (UDIM)")
    print("=" * 50)
